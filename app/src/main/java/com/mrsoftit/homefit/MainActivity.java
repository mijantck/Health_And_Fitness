...
import com.mrsoftit.homefit.fragment.Fragment_Calculate;
import com.mrsoftit.homefit.fragment.Fragment_Reminder;
import com.mrsoftit.homefit.fragment.Fragment_Walk_and_Step;
import com.mrsoftit.homefit.fragment.Fragment_Workout;
import com.mrsoftit.homefit.fragment.MainFragment;
import com.onesignal.OneSignal;

public class MainActivity extends AppCompatActivity implements OnNavigationItemSelectedListener {
    BottomNavigationView bottomNavigation;

    private static final String ONESIGNAL_APP_ID = "7bc3eb7e-a712-4cc9-abb2-b0f78d74c307";
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        if (itemId == R.id.nav_rateus) {
            startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("http://play.google.com/store/apps/details?id=com.mrsoftit.homefit")));
        } else if (itemId == R.id.nav_share) {

            Intent intent2 = new Intent("android.intent.action.SEND");
            intent2.setType("text/plain");
            StringBuilder sb3 = new StringBuilder();
            sb3.append("Best Free Health & Fitness app download now.\n Thnak You!\n  https://play.google.com/store/apps/details?id=com.mrsoftit.homefit");
        ...
        }else  if(itemId == R.id.nav_privacy)
        {
            ...
            Uri uri = Uri.parse("https://sites.google.com/view/myclssplanner/privacy?authuser=0");
