package com.mrsoftit.homefit.fragments
...
import com.mrsoftit.homefit.helpers.AlarmHelper
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == 999) {
            ...
            if (uri != null) {
               ...
               etRingtone.editText!!.setText(ringtone.getTitle(mCtx))
                ...
                // You might want to show an error message or perform another action.
            }
        }
    }
}