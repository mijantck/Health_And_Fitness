...
package com.mrsoftit.homefit.WalkandStep.services;
...
import com.mrsoftit.homefit.WalkandStep.activities.TrainingActivity;
import com.mrsoftit.homefit.WalkandStep.models.StepCount;
import com.mrsoftit.homefit.WalkandStep.persistence.StepCountPersistenceHelper;
import com.mrsoftit.homefit.WalkandStep.persistence.TrainingPersistenceHelper;
import com.mrsoftit.homefit.WalkandStep.persistence.WalkingModePersistenceHelper;
import com.mrsoftit.homefit.WalkandStep.utils.StepDetectionServiceHelper;
import com.mrsoftit.homefit.WalkandStep.utils.UnitHelper;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.mrsoftit.homefit.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.mrsoftit.homefit.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.mrsoftit.homefit.TOTAL_STEPS";
