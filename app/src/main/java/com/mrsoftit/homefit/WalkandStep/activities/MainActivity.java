...
import com.mrsoftit.homefit.WalkandStep.fragments.MainFragment;
...
//    }
    ...
    public void onResume() {
        ...
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.SCHEDULE_EXACT_ALARM) != PackageManager.PERMISSION_GRANTED) {
            // Permission is not granted, request it
            ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.SCHEDULE_EXACT_ALARM}, 1001);
        }
...
//    }
    ...
    public void onBackPressed() {
        ...
        Intent  intent = new Intent(getContext(), com.mrsoftit.homefit.MainActivity.class);
        startActivity(intent);
